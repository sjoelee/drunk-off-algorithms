...
def partition(array, left_idx, right_idx)
  ...
  p = array[left_idx] #set pivot as leftmost element of array
  pivot_idx = left_idx
...
#  puts "from partition num_comp = #{num_comp}"
...
#a = [1, 3, 2] #3 comparisons
#a = [2, 1, 3] #2 comparisons
#a = [2, 3, 1] #2 comparisons
#a = [3, 1 ,2] #3 comparisons
